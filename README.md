...
More detail: **[ARCHITECTURE.md](./ARCHITECTURE.md)** · Auth/sync design: **[docs/PLAN-auth-sync-offline.md](./docs/PLAN-auth-sync-offline.md)** · Full cloud setup (Supabase, Vercel, EAS, OAuth): **[docs/DEPLOYMENT.md](./docs/DEPLOYMENT.md)** · **Web / PWA (browser, no App Store):** **[docs/WEB-DEPLOYMENT.md](./docs/WEB-DEPLOYMENT.md)** · **Expo Go on iPhone (tunnel, no Apple Dev fee):** **[docs/EXPO-GO-IOS-TUNNEL.md](./docs/EXPO-GO-IOS-TUNNEL.md)**
